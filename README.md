...
Here I am using this type of VGA test signal generator (https://es.aliexpress.com/item/33056599680.html). The VGA test signal generator is cyanoacrylate-glued to the PCB after doing the corresponding wire connections (see pics). 
